 ...
 * 리포지터리 설정 클래스
 *
 * <p>DDD 원칙: - 도메인 계층은 인프라스트럭처에 의존하지 않음 - 인프라스트럭처 계층에서 도메인 인터페이스의 구현체를 제공 - 의존성 역전 원칙 (DIP) 적용 -
...
public class RepositoryConfig {
	 ...
	 * 주문 리포지터리 어댑터 등록
	 *
	 * <p>어댑터 패턴을 사용하여: - 도메인 인터페이스 (OrderRepository)와 - JPA 인터페이스 (JpaOrderRepository)를 연결
	 */
	@Bean
