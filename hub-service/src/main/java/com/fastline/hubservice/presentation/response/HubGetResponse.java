...
public final class HubGetResponse {
    ...
    private HubGetResponse(UUID hubId, UUID centralHubId, boolean isCentral, String name, String address,
    ...
    public UUID getCentralHubId() { return centralHubId; }
    public boolean isCentral() { return isCentral; }
