...
public class HubController {
	...
	@io.swagger.v3.oas.annotations.responses.ApiResponses({
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "생성 성공", content = @Content(schema = @Schema(implementation = HubCreateResponse.class))),
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "유효성 오류"),
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "중복 충돌")
	})
	@PostMapping({""})
	...
	@io.swagger.v3.oas.annotations.responses.ApiResponses({
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = HubGetResponse.class))),
	...
	public ResponseEntity<ApisResponse<Page<HubListResponse>>> listHubs(
            @ParameterObject @org.springframework.web.bind.annotation.ModelAttribute HubListRequest request,
