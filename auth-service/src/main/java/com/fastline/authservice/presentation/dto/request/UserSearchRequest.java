...
public record UserSearchRequest(Integer page,
								Integer size,
								UUID hubId,
								String username,
								String role,
	...
	public UserSearchRequest(Integer page, Integer size, UUID hubId, String username, String role, String status, String sortBy, Boolean sortAscending) {
