...
public interface UserControllerSwagger {
	...
	@Operation(
			summary = "사용자 정보 검색",
			description =
					"MASTER 또는 사용자가 소속된 HUB_MANAGER만이 가능하며 검색 조건을 기반으로 사용자 정보를 조회합니다.\n 허브 관리자의 경우 자동으로 소속된 허브로 검색이 제한됩니다.")
	@ApiResponses({
		@io.swagger.v3.oas.annotations.responses.ApiResponse(
				responseCode = "201",
				description = "요청 성공"),
	...
	@Operation(
			summary = "회원 탈퇴 승인",
			description =
					"MASTER 또는 사용자가 소속된 HUB_MANAGER만이 가능하며 해당 유저아이디의 탈퇴를 승인합니다.\n 탈퇴를 신청한 사용자만 탈퇴 승인이 가능합니다.")
	@ApiResponses({
		@io.swagger.v3.oas.annotations.responses.ApiResponse(
				responseCode = "201",
				description = "요청 성공"),
