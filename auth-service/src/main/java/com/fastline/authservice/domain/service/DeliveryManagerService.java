...
public class DeliveryManagerService {
	...
	@Transactional
	public void createDeliveryManager(
			UserDetailsImpl manager, DeliveryManagerCreateRequestDto requestDto) {
		// 승인 대상 유저 확인
	...
	public Page<DeliveryManagerResponseDto> getDeliveryManagers(
			UserDetailsImpl userDetails, @Valid DeliveryManagerSearchRequestDto requestDto) {
	...
	public void updateDeliveryManager(
			UserDetailsImpl manager, @Valid DeliveryManagerCreateRequestDto requestDto) {
		// 승인 대상 유저 확인
		User user = checkUser.userCheck(requestDto.getUserId());
	...
	public void deleteDeliveryManager(
			UserDetailsImpl manager, @Valid DeliveryManagerDeleteRequestDto requestDto) {
		// 승인 대상 유저 확인
		User user = checkUser.userCheck(requestDto.getUserId());
